...
input PlaybookWhereInput {
  ...
  publishedAt_gte: DateTime
  initialPublishedAt: DateTime
  initialPublishedAt_not: DateTime
  initialPublishedAt_in: [DateTime!]
  initialPublishedAt_not_in: [DateTime!]
  initialPublishedAt_lt: DateTime
  initialPublishedAt_lte: DateTime
  initialPublishedAt_gt: DateTime
  initialPublishedAt_gte: DateTime
  type: PackageType
  type_not: PackageType
  type_in: [PackageType!]
  type_not_in: [PackageType!]
