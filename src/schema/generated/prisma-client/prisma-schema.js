...
input GraphicProjectCreateManyInput {
  create: [GraphicProjectCreateInput!]
  connect: [GraphicProjectWhereUniqueInput!]
}
...
input GraphicProjectScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  visibility_in: [Visibility!]
  visibility_not_in: [Visibility!]
  AND: [GraphicProjectScalarWhereInput!]
  OR: [GraphicProjectScalarWhereInput!]
  NOT: [GraphicProjectScalarWhereInput!]
}
...
input GraphicProjectUpdateDataInput {
  publishedAt: DateTime
  type: ProjectType
  title: String
  copyright: Copyright
...
input GraphicProjectUpdateManyDataInput {
  publishedAt: DateTime
  type: ProjectType
  title: String
  copyright: Copyright
...
input GraphicProjectUpdateManyInput {
  create: [GraphicProjectCreateInput!]
  update: [GraphicProjectUpdateWithWhereUniqueNestedInput!]
  upsert: [GraphicProjectUpsertWithWhereUniqueNestedInput!]
  delete: [GraphicProjectWhereUniqueInput!]
  connect: [GraphicProjectWhereUniqueInput!]
  set: [GraphicProjectWhereUniqueInput!]
  disconnect: [GraphicProjectWhereUniqueInput!]
  deleteMany: [GraphicProjectScalarWhereInput!]
  updateMany: [GraphicProjectUpdateManyWithWhereNestedInput!]
}
...
input GraphicProjectUpdateManyWithWhereNestedInput {
  where: GraphicProjectScalarWhereInput!
  data: GraphicProjectUpdateManyDataInput!
}

input GraphicProjectUpdateWithWhereUniqueNestedInput {
  where: GraphicProjectWhereUniqueInput!
  data: GraphicProjectUpdateDataInput!
}

input GraphicProjectUpsertWithWhereUniqueNestedInput {
  where: GraphicProjectWhereUniqueInput!
...
input PackageUpdateManyInput {
  create: [PackageCreateInput!]
  update: [PackageUpdateWithWhereUniqueNestedInput!]
  upsert: [PackageUpsertWithWhereUniqueNestedInput!]
...
input PackageUpdateWithWhereUniqueNestedInput {
  where: PackageWhereUniqueInput!
  data: PackageUpdateDataInput!
}

input PackageUpsertWithWhereUniqueNestedInput {
  where: PackageWhereUniqueInput!
...
type Project {
  id: ID!
  videos(where: VideoProjectWhereInput, orderBy: VideoProjectOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [VideoProject!]
  graphics(where: GraphicProjectWhereInput, orderBy: GraphicProjectOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [GraphicProject!]
...
input ProjectCreateInput {
  id: ID
  videos: VideoProjectCreateManyInput
  graphics: GraphicProjectCreateManyInput
  packages: PackageCreateManyInput
}
...
input ProjectUpdateInput {
  videos: VideoProjectUpdateManyInput
  graphics: GraphicProjectUpdateManyInput
  packages: PackageUpdateManyInput
}
...
input ProjectWhereInput {
  ...
  id_ends_with: ID
  id_not_ends_with: ID
  videos_every: VideoProjectWhereInput
  videos_some: VideoProjectWhereInput
  videos_none: VideoProjectWhereInput
  graphics_every: GraphicProjectWhereInput
  graphics_some: GraphicProjectWhereInput
  graphics_none: GraphicProjectWhereInput
...
input VideoProjectCreateManyInput {
...
input VideoProjectScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  visibility_in: [Visibility!]
  visibility_not_in: [Visibility!]
  AND: [VideoProjectScalarWhereInput!]
  OR: [VideoProjectScalarWhereInput!]
  NOT: [VideoProjectScalarWhereInput!]
}
...
input VideoProjectUpdateDataInput {
  publishedAt: DateTime
  projectType: ProjectType
  projectTitle: String
  descPublic: String
...
input VideoProjectUpdateManyDataInput {
  publishedAt: DateTime
  projectType: ProjectType
  projectTitle: String
  descPublic: String
...
input VideoProjectUpdateManyInput {
  create: [VideoProjectCreateInput!]
  update: [VideoProjectUpdateWithWhereUniqueNestedInput!]
  upsert: [VideoProjectUpsertWithWhereUniqueNestedInput!]
  delete: [VideoProjectWhereUniqueInput!]
  connect: [VideoProjectWhereUniqueInput!]
  set: [VideoProjectWhereUniqueInput!]
  disconnect: [VideoProjectWhereUniqueInput!]
  deleteMany: [VideoProjectScalarWhereInput!]
  updateMany: [VideoProjectUpdateManyWithWhereNestedInput!]
}
...
input VideoProjectUpdateManyWithWhereNestedInput {
  where: VideoProjectScalarWhereInput!
  data: VideoProjectUpdateManyDataInput!
}

input VideoProjectUpdateWithWhereUniqueNestedInput {
  where: VideoProjectWhereUniqueInput!
  data: VideoProjectUpdateDataInput!
}

input VideoProjectUpsertWithWhereUniqueNestedInput {
  where: VideoProjectWhereUniqueInput!
